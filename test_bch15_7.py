...
class Test(TestCase):
    def test_encode_bch(self, k=7):
        ...
        for data in itertools.product([0, 1], repeat=k):
            ...
            # Custom encoding
            codeword_bits, generator_bits, parity_bits = bch15_7.encode_bch(data, output="all")
            # True encoding
            true_codeword_bits, true_generator_bits, true_parity_bits = bch15_7.true_encode_bch(data, output="all")
    ...
    def test_decode_bch(self, k=7, t=2):
        ...
        for data in itertools.product([0, 1], repeat=k):
            ...
            codeword_bits = bch15_7.encode_bch(data, output="codeword")
            ...
            for error_count in range(t + 1):  # Test 0, 1, ..., t bit errors
                ...
                decoded_bits, custom_error_count = bch15_7.decode_bch(flipped_codeword_bits)
                true_decoded_bits, true_error_count = bch15_7.true_decode_bch(flipped_codeword_bits)
